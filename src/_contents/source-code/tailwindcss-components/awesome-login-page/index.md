...
<div class="
  ...
  bg-gradient-to-tr from-blue-900 to-blue-500
">
  <div class="
    bg-image 
    w-full sm:w-1/2 md:w-9/12 lg:w-1/2 
    mx-3 md:mx-5 lg:mx-0 
    bg-center bg-cover bg-blue-600
    flex flex-col md:flex-row items-center 
    rounded overflow-hidden shadow-md z-10
  ">
    <div class="
      w-full md:w-1/2 
      flex flex-col justify-center items-center 
      bg-opacity-25 bg-blue-600 backdrop
    ">
      <h1 class="
